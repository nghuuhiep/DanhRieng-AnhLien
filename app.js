var slide = [
    `Chào cậu   ALi Dương   - người nhận được nhiều sự chú ý cũng như người đã được nhận lá thư này.   
    Được gửi bởi Hữu Hiệp   - người mà cậu đang ghét  vì những việc làm của cậu ta trong quá khứ. (bấm bên phải -->)`,

    `Tao biết bây giờ là trễ   để nói lời xin lỗi tới mày    nhưng hy vọng tớ vẫn còn cơ hội ?      
    Mong Ánh Liên sẽ đọc hết. `,

    `Bắt đầu từ giữa năm lớp 9 và từ đó những việc làm KHÔNG suy nghĩ của tao đã ảnh hưởng tới mày,   dù không nhiều nhưng đã kiến rất khó ưa      .  .  .   phải không?      
    ...
    Mà là bản thân Ánh Liên.   
    Lần đầu tiên là trên trường   (khi không son, không phấn, không cầu kì),  giờ vẫn vậy  nhưng vẫn không hiểu vì sao mày lại có thể kiến tao ngơ ngác.`,

    `Như tao đã nói, mục đích đến đây là nhận lỗi và mong được mày bỏ qua.     Những thứ đáng ghét về tao, tao xin nhận hết.   
    Xin lỗi bình thường, nhắn cậu thì không thành tâm.   Cậu là người đặc biệt nên cần cách thức đặc biệt`,
    ...
    Tôi  không  giỏi  văn  vở nhưng   đã  từng  rất  giỏi  thương  cậu.`,

    `Nhưng    tao biết mày đã có bồ rồi,    mà nếu chưa thì tao cũng không đáng có cơ hội.   Tao có thể làm người bạn mày chứ?`,

    `Qua mọi thứ,   chúc Ánh Liên mãi đẹp,  người bên cậu đủ tốt,   những người đến với cậu với ý tốt.      
    Mọi điều đến với cậu đều là cây bài thắng và làm chủ nhé!`
]
var slideName = [
    "Xin chào",
    "Mục đích",
